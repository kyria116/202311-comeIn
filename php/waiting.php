...
<body class="lang_tw" data-menu="5">
    ...
    <main>
        <div class="kv_banner">
            <img src="dist/images/kv/waiting.jpg" class="pc">
            <img src="dist/images/kv/waiting_mo.jpg" class="mo">
            <div class="txt">
                <div class="subtitle">WAITING ROOM</div>
                <div class="title">即時候診資訊</div>
            </div>
        </div>
        ...
        <div class="waiting">
            <div class="container">
                ...
                <div class="linkTelBox">
                    <a href="javascript:;" target="_blank" class="linkTel">
                        <div class="leftBox">
                            <div class="title">加入LINE@搜尋</div>
                        </div>
                        <div class="rightBox">
                            <div class="img"></div>
                            <div class="line">康迎身心科診所</div>
                        </div>
                    </a>
                </div>
            </div>
