...
<body class="lang_tw" data-menu="4">
    ...
    <main data-health="1">
        ...
        <div class="health">
            <div class="container">
                <?php
                    include "quote/template/tag_menu_health.php";
                ?>
                ...
                <div class="healthContain healthVideo">
                    <ul>
                        ...
                        <li>
                            <a href="javascript:;" data-yt="95gHggJZoJM?si=N_Ofjjf6nmlVG--E">
                                <div class="img" style="background: url('dist/images/img.jpg') center / contain no-repeat">
                                    <!-- <img src="dist/images/video.jpg"> -->
                                </div>
                                <div class="txt">
                        ...
                        <li>
                            <a href="javascript:;" data-yt="37eozmkX6lQ?si=hvXmGceDje-dM1y7">
                                <div class="img" style="background: url('dist/images/img.jpg') center / contain no-repeat">
                                    <img src="dist/images/video.jpg">
                                </div>
                                <div class="txt">
