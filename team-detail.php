...
<body class="lang_tw" data-menu="0">
    ...
    <main class="detail">
        <div class="kv_banner">
            <img src="dist/images/kv/team.jpg" class="pc">
            <img src="dist/images/kv/team_mo.jpg" class="mo">
            <div class="txt">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="box">
                                                    ...
                                                    <a href="javascript:;" target="_blank">4/1起</a>
                                                    <br>
            ...
            <div class="container_swiper">
                <div class="relevant">
                    ...
                    <div class="swiper mySwiper">
                        ...
                        <div class="swiperBtn">
                            <div class="swiper-button-next nextService"></div>
                            <div class="swiper-button-prev prevService"></div>
                        </div>
                    </div>
                </div>
                <div class="btnBox">
                    <a href="javascript:history.go(-1);" class="btn_blue back">
                        <div class="arrow"></div>
                        返回
                    </a>
                    <a href="podcast.php" class="btn_blue">
                        更多資訊
                        <div class="arrow"></div>
                    </a>
                </div>
